    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        toggleEditing: function () {
            if (!this.isEdit) {
                ...
                console.log(ops);
                console.log(ops.layerInfos);

                ops.layerInfos.forEach(myFunction);
                function myFunction(item, index) {
                    if(item.fieldInfos){
                        item.fieldInfos.push({fieldName: 'TEST', isEditable: false, label: 'Test'});
                        ops.layerInfos[index].fieldInfos.push({fieldName: 'TEST', isEditable: false, label: 'Test'});
                    }
                    console.log('item, fieldInfos, relationships');
                    console.log(item);
                    console.log(item.fieldInfos);
                    console.log(item.featureLayer.relationships);
